...
export interface IdentityService {
  ...
  updateUsers (userid: String, username: String, givenName:String, familyName:String, phoneNumber:String, auth: String, baseurl: String, tenant: String, authType: String): Promise<any>;
}
